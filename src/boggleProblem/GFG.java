 ...
 *         {{'G', 'I', 'Z'}, {'U', 'E', 'K'}, {'Q', 'S', 'E'}}; isWord(str):
 *         returns true if str is present in dictionary else false.
 * 
 *         Output: Following words of dictionary are present GEEKS QUIZ
 * 
 * 
 *         The idea is to consider every character as a starting character and
 *         find all words starting with it. All words starting from a character
 *         can be found using Depth First Traversal. We do depth first traversal
 *         starting from every cell. We keep track of visited cells to make sure
